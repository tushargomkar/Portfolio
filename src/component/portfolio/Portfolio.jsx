  ...
  return (
    <section className='work container section' id='work'>
        ...
        <span className='work__item' onClick={()=>setItems(Menu)}>ALL</span>
            <span className='work__item' onClick={()=>filterItem("HTML/CSS")}>HTML/CSS</span>
            <span className='work__item' onClick={()=>filterItem("Mern")}>Mern</span>
            <span className='work__item' onClick={()=>filterItem("JS")}>JS</span>
          ...
          {items.map((elem)=>{
            ...
            return(
              <div className='work__card' key={id}>
                 ...
                 <a href="https://github.com/tushargomkar" className='work__button'>
