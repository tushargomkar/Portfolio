        ...
        <div className='blog__container grid'>
           <div className='blog__card'>
                 <div className='blog__thumb'>
                     ...
                     <a href="#"> <img src={Image1} alt="image" className='blog__img' /></a>
                 </div>

                 <div className='blog__details'>
                    <h3 className='blog__title'> 5 Best App Development Tool for your Project</h3>
           ...
           <div className='blog__card'>
                 <div className='blog__thumb'>
                     ...
                     <a href="#"> <img src={Image2} alt="image" className='blog__img' /></a>
                 </div>
           ...
           <div className='blog__card'>
                 <div className='blog__thumb'>
                     ...
                     <a href="#"> <img src={Image3} alt="image" className='blog__img' /></a>
                 </div>
